...
function fetch_and_display_posts()
{
    ...
    xhr.open("GET", "http://merca3w.com/v2/wp-admin/admin-ajax.php?action=posts", true);
    xhr.onload = function(){
...
function login()
{
    ...
    var xhr = new XMLHttpRequest();
    xhr.open("GET", "http://merca3w.com/v2/wp-admin/admin-ajax.php?action=login&username=" + encodeURIComponent(username) + "&password=" + encodeURIComponent(password));
    xhr.onload = function(){
